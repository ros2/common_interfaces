...
The package `visualization_msgs` claims to be in the **Quality Level 2** category.
...
`visualization_msgs` has the following runtime ROS dependencies, which are at or above Quality Level 2:
