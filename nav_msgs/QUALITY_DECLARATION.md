This document is a declaration of software quality for the `nav_msgs` package, based on the guidelines in [REP-2004](https://www.ros.org/reps/rep-2004.html).
...
`nav_msgs` is at a stable version, i.e. `>= 1.0.0`.
...
* `builtin_interfaces`: [QL 3](https://raw.githubusercontent.com/ros2/rcl_interfaces/master/builtin_interfaces/QUALITY_DECLARATION.md)
